...
const projects: Project[] = [
  ...
  },
  {
    ...
    year: "2024",
    details:
      "Inspired by Nordic design philosophy, this bedroom creates a sanctuary of calm. Natural oak, linen textiles, and a muted palette establish tranquility.",
  },
  {
    id: 3,
    ...
    year: "2023",
    details:
      "A chef's dream realized through meticulous planning and premium materials. Italian marble countertops and custom brass hardware deliver both visual drama and practical efficiency.",
  },
  {
    id: 4,
    ...
    year: "2023",
    details:
      "Floor-to-ceiling oak shelving creates an immersive library atmosphere while maintaining modern work functionality. Integrated lighting and ergonomic custom furniture support focused productivity.",
  },
  {
    id: 5,
    ...
    year: "2024",
    details:
      "Large windows frame city views while abundant plants bring nature inside. Modular seating arrangements adapt to various social configurations, creating an inviting atmosphere.",
  },
  {
    id: 6,
  ...
  },
  {
    ...
    year: "2024",
    details:
      "The interior utilizes a dark, rich palette of smoked oak and leather to anchor the space against the expansive, ever-changing backdrop of the cityscape. Smart home technology is seamlessly integrated throughout.",
  },
  {
    id: 9,
    ...
    year: "2023",
    details:
      "Located within a historic museum, the cafe's design respects the building's heritage while offering a modern, bustling atmosphere. Terrazzo flooring, bespoke wooden furniture, and a high ceiling promote a comfortable flow for high foot traffic.",
  },
];
    ...
    >
      {project.video ? (
        <div className="relative w-full h-full">
          <video
            ref={videoRef}
            className="w-full h-full object-cover transition-all duration-1200 group-hover:scale-105"
            src={project.video}
            preload="metadata"
            playsInline
            muted
      ...
      {selectedProject && (
        ...
        >
          ...
          >
            <button
              onClick={() => setSelectedProject(null)}
              className="absolute top-4 right-4 z-10 bg-background/80 hover:bg-background shadow-sm border border-border rounded-full p-2 cursor-pointer transition-transform duration-300 hover:scale-110"
            ...
            <div className="flex flex-col h-full overflow-y-auto p-6 md:p-10 lg:p-12">
              <div className="mb-5 flex flex-wrap items-center gap-3 font-lora text-muted-foreground text-sm tracking-wide">
              ...
              <h2 className="text-2xl md:text-3xl font-monasans font-semibold text-heading mb-4 text-balance">
                {selectedProject.title}
              </h2>

              <p className="text-sm md:text-base font-poppins text-body leading-relaxed mb-8">
                {selectedProject.description}
              </p>

              <div className="border-t border-border pt-6 md:pt-8">
                <h3 className="text-lg md:text-xl font-monasans font-semibold text-heading mb-3">
                  Project Details
                </h3>
                <p className="font-poppins text-body leading-relaxed md:leading-7">
                  {selectedProject.details}
                </p>
              </div>

              <div className="mt-8 md:mt-10 flex flex-col sm:flex-row gap-3 sm:gap-4">
                <button className="px-6 py-3 bg-black text-white font-monasans font-semibold rounded-lg cursor-pointer">
                  Contact Us
                </button>
                <button
                  className="px-6 py-3 border border-border text-heading bg-background/60 hover:bg-background font-monasans font-semibold rounded-lg cursor-pointer"
                  onClick={() => setSelectedProject(null)}
                >
                  Close
                </button>
